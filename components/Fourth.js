            ...
            <div className='lg:hidden flex flex-col mx-10 mt-20 my-44'>
                ...
                <motion.div
                    ...
                    <div className={`${raleway.className}  space-y-5 my-6`}>
                        <h1 className='text-2xl md:text-5xl font-bold'>Monetize Your Ideas<br /></h1>
                        <h1 className='text-lg md:text-2xl font-normal'>Transform Your Projects into Profit - Sell Your Innovations Here</h1>
                    </div>
                </motion.div>
            </div>

            {/* Hidden on mobile screens */}
            <div className='hidden lg:flex flex-col mt-20 mx-32 my-44'>
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.7 }}
